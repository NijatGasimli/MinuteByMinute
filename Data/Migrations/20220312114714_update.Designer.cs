...
namespace Data.Migrations
{
    ...
    [Migration("20220312114714_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entity.AdminPanelEntityes.DeclaredCargos", b =>
                {
                    ...
                    b.Property<int?>("TurkishStorageId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TurkishStorageId")
                        .IsUnique()
                        .HasFilter("[TurkishStorageId] IS NOT NULL");
            ...
            modelBuilder.Entity("Core.Entity.AdminPanelEntityes.DeclaredCargos", b =>
                {
                    b.HasOne("Core.Entity.AdminPanelEntityes.TurkishStorage", "TurkishStorage")
                        .WithOne("Declared")
                        .HasForeignKey("Core.Entity.AdminPanelEntityes.DeclaredCargos", "TurkishStorageId");
                });
