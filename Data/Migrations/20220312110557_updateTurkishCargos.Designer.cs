...
namespace Data.Migrations
{
    ...
    [Migration("20220312110557_updateTurkishCargos")]
    partial class updateTurkishCargos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entity.AdminPanelEntityes.TurkishStorage", b =>
                {
                    ...
                    b.Property<int?>("DeclaredCargosId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeclaredCargosId")
                        .IsUnique()
                        .HasFilter("[DeclaredCargosId] IS NOT NULL");
            ...
            modelBuilder.Entity("Core.Entity.AdminPanelEntityes.TurkishStorage", b =>
                {
                    b.HasOne("Core.Entity.AdminPanelEntityes.DeclaredCargos", "Declared")
                        .WithOne("TurkishStorage")
                        .HasForeignKey("Core.Entity.AdminPanelEntityes.TurkishStorage", "DeclaredCargosId");
                });
